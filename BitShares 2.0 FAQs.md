...
===
###### In the pre-compiled version (available [here](https://github.com/bitshares/bitshares-2/releases)), in the `config.ini` file for the wintess node I have this line uncommented by default: `private-key = ["BTS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"]`. Whose private key is this? Why is it pre-defined in this way? Can I safely comment it out?
