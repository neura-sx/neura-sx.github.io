...
===
###### In the pre-compiled version (available [here](https://github.com/bitshares/bitshares-2/releases)), in the `config.ini` file for the wintess node I have this line uncommented by default: `private-key = ["BTS6MRyAjQ..","5KQwrPbwdL.."]`. Whose private key is this? Why is it pre-defined in this way? Can I safely comment it out?
